...
outfileName = "Dataset_V49_IP3D_pTFrac_dR_hits_3m.pkl" # V47 test version
outfileName = "Dataset_V50_IP3D_pTFrac_dR_hits_3m.pkl" # V47 test version

#outfileName = "Dataset_V47_IP3D_pTFrac_dR_hits_3m.pkl" (rel20.7 sample)
#outfileName = "Dataset_V48_IP3D_pTFrac_dR_hits_3m.pkl" (test case of V47)


#outfileName = "Dataset_V72_IP3D_pTFrac_dR_hits_5m.pkl"
#outfileName = "Dataset_V73_IP3D_pTFrac_dR_hits_5m.pkl" ## Rel 21 hybrid sample storing cal and uncal jet quantities
outfileName = "Dataset_V74_IP3D_pTFrac_dR_hits_5m.pkl" ## Rel 21 ttbar
...
#ROOTfileNames = glob.glob("/atlas/local/BtagOptimizationNtuples/V47/group.perf-flavtag.mc15_13TeV.410000.PowhegPythiaEvtGen_s2608_s2183_r7725_r7676.BTAGNTUP_V47_full_Akt4EMTo/group.perf-flavtag.8324358.Akt4EMTo._001*.root*")
...
ROOTfileNames = glob.glob("/atlas/local/BtagOptimizationNtuples/group.perf-flavtag.410000.PowhegPythiaEvtGen.AOD.e3698_s2997_r8903_r8906.v21-1.db-b5223bf2_Akt4EMTo/*.root")
...
for fname in ROOTfileNames:
    ...
    with root_open(fname) as f:
        ...
        jet_mv2c20 = np.hstack(tuple(rnp.tree2array(tree, "jet_mv2c10",  stop=Nleft)))        
        ...
        jet_pt_cal  =   np.hstack(tuple(rnp.tree2array(tree, "jet_pt",  stop=Nleft)))        
        jet_eta_cal =   np.hstack(tuple(rnp.tree2array(tree, "jet_eta", stop=Nleft)))        
        ...
        #        print len(jet_eta)
        #        print len(jet_llr)
        #        print len(jet_ip3d_pb)
        #        print len(jet_ip3d_pc)
        #        print len(jet_ip3d_pu)
        #        print len(jet_ip3d_ntrk)
        #        print len(jet_mv2c20)
        #        print len(jet_sv1_llr)
        #        print len(jet_mv2c10)
        #        print len(jet_JVT)
        #        print len(jet_aliveafterOR)
        #        print len(jet_pt_cal)
        #        print len(jet_eta_cal)
        label_arr = np.dstack( (jet_flav, jet_pt, jet_eta, jet_llr, jet_ip3d_pb, jet_ip3d_pc, jet_ip3d_pu, jet_ip3d_ntrk, jet_mv2c20, jet_sv1_llr, jet_mv2c10, jet_JVT, jet_aliveafterOR, jet_pt_cal, jet_eta_cal) )[0]
